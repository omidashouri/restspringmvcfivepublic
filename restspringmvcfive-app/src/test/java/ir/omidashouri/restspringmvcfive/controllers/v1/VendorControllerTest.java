...
//    this is integration test
    ...
    @MockBean//inject vendorService into mock object: here spring manage every thing
    ...
    public void createNewVendor() throws Exception {
        ...
        given(vendorService.createNewVendor(ArgumentMatchers.any(VendorDTO.class))).willReturn(vendorDTO_1);
    ...
    public void updateVendor() throws Exception {
        ...
        given(vendorService.saveVendorByDTO(anyLong(),ArgumentMatchers.any(VendorDTO.class))).willReturn(vendorDTO_1);
    ...
    public void deleteVendor() throws Exception {
        ...
        BDDMockito.then(vendorService).should().deleteVendorById(anyLong());
    }
}